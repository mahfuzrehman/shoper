<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
      <a href="index.html" class="app-brand-link">
        ...
        <span class="app-brand-text demo menu-text fw-bolder ms-2">Shopper</span>
      </a>
        ...
        <ul class="menu-sub">
          ...
          <li class="menu-item">
            <a href="{{route('subcategories')}}" class="menu-link">
              <div data-i18n="Manage Sub-Category">Manage Sub-Category</div>
            </a>
          </li>
        </ul>
      </li>
        ...
        <ul class="menu-sub">
          <li class="menu-item">
            <a href="{{route('brand.create')}}" class="menu-link">
              <div data-i18n="Add Brands">Add Brands</div>
            </a>
          </li>
          <li class="menu-item">
            <a href="{{route('brands')}}" class="menu-link">
              <div data-i18n="Manage Brands">Manage Brands</div>
            </a>
          </li>
        </ul>
      </li>
        ...
        <ul class="menu-sub">
          <li class="menu-item">
            <a href="{{route('unit.create')}}" class="menu-link">
              <div data-i18n="Add Unit">Add Unit</div>
            </a>
          </li>
          <li class="menu-item">
...
{{--       
        ...
        <ul class="menu-sub">
          <li class="menu-item">
            <a href="pages-account-settings-account.html" class="menu-link">
              <div data-i18n="Add Colors">Add Colors</div>
            </a>
          </li>
          <li class="menu-item">
            <a href="pages-account-settings-notifications.html" class="menu-link">
              <div data-i18n="Manage Colors">Manage Colors</div>
            </a>
          </li>
        </ul>
      </li> --}}
      ...
      {{-- <li class="menu-item">
        ...
        <ul class="menu-sub">
          <li class="menu-item">
            <a href="pages-account-settings-account.html" class="menu-link">
              <div data-i18n="Add Size">Add Size</div>
            </a>
          </li>
          <li class="menu-item">
            <a href="pages-account-settings-notifications.html" class="menu-link">
              <div data-i18n="Manage Size">Manage Size</div>
            </a>
          </li>
        </ul>
      </li> --}}
      ...
      <li class="menu-item">
        <a href="#" class="menu-link">
          <div data-i18n="Analytics">Shopper Info</div>
        </a>
      </li>
    </ul>
  </aside>