                      ...
                      <div class="card-body">
                        ...
                        @csrf
                          ...
                          <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                              <input type="number" name="product_quantity" class="form-control" placeholder="" />
                            </div>
                          </div>
                          <div class="row mb-3">
                            <label class="col-sm-2 col-form-label" for="basic-default-name">Long Description</label>
                            <div class="col-sm-10">
                              <textarea type="text" name="product_long_desc" class="form-control" cols="30" rows="5"></textarea>
                            </div>
                          </div>
                          <div class="row mb-3">
                            <label class="col-sm-2 col-form-label" for="basic-default-name">Short Description</label>
                            <div class="col-sm-10">
                              <textarea type="text" name="product_short_desc" class="form-control" cols="30" rows="5"></textarea>
                            </div>
                          </div>
                          <div class="row mb-3">
                          ...
                          <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <label><input type="radio" name="product_status" checked value="1" class="mx-2">Published</label>
                                <label><input type="radio" name="product_status" value="0" class="mx-2">Unpublished</label>
                            </div>
                          </div>
