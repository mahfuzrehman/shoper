                      ...
                      <div class="card-body">
                        ...
                        @csrf
                          ...
                          <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                              <textarea type="text" name="brand_desc" class="form-control" cols="30" rows="5"></textarea>
                            </div>
                          </div>
                          <div class="row mb-3">
                            <label class="col-sm-2 col-form-label">Pulication Status</label>
                            <div class="col-sm-10">
                                <label><input type="radio" name="brand_status" value="1" class="mx-2">Published</label>
                                <label><input type="radio" name="brand_status" value="0" class="mx-2">Unpublished</label>
                            </div>
                          </div>
