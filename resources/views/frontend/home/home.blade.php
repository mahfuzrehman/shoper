				...
				<div class="row">
					...
					@foreach ($categories as $category)
						<div class="col-md-4 col-xs-6">
							<div class="shop">
								<div class="shop-img">
									<img src="{{isset($category->category_image) ? asset($category->category_image) : '' }}" style="height: 240px; width:360px" alt="">
								</div>
								<div class="shop-body">
						...
						<div class="section-title">
							...
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									@foreach ($categories as $category)
										<li class=""><a data-toggle="tab" href="#tab1">{{$category->category_name}}</a></li>
									@endforeach
									...
									<div class="products-slick" data-nav="#slick-nav-1">
										...
										<div class="product">
											<div class="product-img">
												<img src="{{isset($product->product_image) ? asset($product->product_image) : '' }}" style="height: 309px; width:263px" alt="">
											...
											<div class="product-body">
												...
												<h4 class="product-price">${{$product->selling_price}}<del class="product-old-price">${{$product->regular_price}}</del></h4>
